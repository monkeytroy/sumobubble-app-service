  ...
  return (
    <div className="flex flex-col gap-24">
      <div id="product" className="relative isolate min-h-screen flex justify-center items-center">
        <div className="absolute inset-x-0 -z-20 transform-gpu overflow-hidden blur-3xl top-0"
          aria-hidden="true">
          <div className="relative -top-48 left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] 
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-32 lg:py-36">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              An easy to create and use helper for your organizations website.  Chat, summarized info, easy feedback and more.
            </p>
            {false && 
        ...
        <div className="absolute inset-x-0 -z-10 transform-gpu overflow-hidden 
          ...
          aria-hidden="true">
          <div className="relative -top-24 left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] 
