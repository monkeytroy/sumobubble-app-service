...
const translations: {[key: string]: any} = {
  ...
  'ASV': 'American Standard Version (ESV)'
}
...
const VerseTranslationSelect = 
  ({ translation, disabled, onChangeTranslation}: 
   {translation: string, 
    disabled?: boolean,
        ...
        <>
          ...
          <div className="relative mt-2">
            <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 
              text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 disabled:opacity-30
              focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
              <span className="block truncate">{translations[translation]}</span>
...
export default VerseTranslationSelect;