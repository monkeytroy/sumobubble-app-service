    ...
    <div className="flex flex-col gap-8 relative">
      ...
      <div className="relative max-w-2xl">
        <div className="flex flex-col gap-4">
          <p className="text-3xl font-bold tracking-tight text-gray-800 sm:text-3xl py-4">
            Account
          </p>
      ...
      <div className="flex flex-col gap-4 max-w-2xl">
        ...
        <div className="text-gray-600">
          Each site represents a location or website where InfoChatApp can be installed with common information, widgets and theme. 
        </div>
      </div>
